...
# beatiful fading between windows
...
# TODO: decide whether it is better to exclude windows in tabbed containers?
EXCLUDE_APP_IDS = ["firefox"]
...
class Fader:
    def __init__(self):
        ...
        for win in ipc.get_tree():
            if win.app_id in EXCLUDE_APP_IDS:
    ...
    def on_window_focus(self, ipc, e):
        ...
        if e.container.app_id in EXCLUDE_APP_IDS:
